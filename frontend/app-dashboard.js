...
function setState(state) {
    ...
    switch(state) {
        case 'initializing':
            ...
            pttButton.className = 'ptt-button-compact';
        ...
        case 'recording':
            ...
            pttButton.className = 'ptt-button-compact recording';
            setPttText('Recording');
            break;
        case 'processing':
            statusText.textContent = 'Transcribing...';
            pttButton.className = 'ptt-button-compact processing';
            setPttText('Processing');
            pttButton.disabled = true;
            break;
        case 'thinking':
            statusText.textContent = 'Thinking...';
            pttButton.className = 'ptt-button-compact thinking';
            setPttText('Thinking');
            pttButton.disabled = true;
            break;
        case 'speaking':
            statusText.textContent = 'Speaking...';
            pttButton.className = 'ptt-button-compact speaking';
            setPttText('Speaking');
            pttButton.disabled = true;
            break;
        case 'error':
            statusText.textContent = 'Error - Click to retry';
            pttButton.className = 'ptt-button-compact error';
